document.addEventListener("DOMContentLoaded", function() {
  ...
  const objective = `Formado em Administração com (ênfase em Sistemas de Informação) pela Estácio de Sá e em Ciências Econômicas pelo Instituto Vianna Junior (FGV), atualmente curso o 4º período de Engenharia de Software e o 1º Período de Análise e Desenvolvimento de Sistemas. Estou cursando o 1º semestre de pós-graduação em Big Data e Ciência Analítica, e tenho interesse em trabalhar com o desenvolvendo de software. Estou passando por uma transição de carreira, na qual busco também conhecer, e aprender a implementar estratégias de migração de aplicações para a nuvem, visando à redução de custos e ao aumento de desempenho. Para isso, almejo uma oportunidade para atuar na área de TI, com foco em Cloud. Tenho experiência em análise de Redes (Modelo OSI, TCP/IP, DNS, etc.) e Desenvolvimento Web. Possuo habilidades em Microsoft Office e Power BI, além de profunda resiliência, garra, boa liderança, ótima comunicação, trabalho em equipe, pensamento analítico e criativo.Tenho experiência em metodologia ágil e processo Scrum.`;
